...
// Color picker colors
inline FGUI::COLOR COLOR_CCOLORPICKER_BG = COLOR2;
inline FGUI::COLOR COLOR_CCOLORPICKER_BORDER = COLOR1;
inline FGUI::COLOR COLOR_CCOLORPICKER_LABEL = TEXTLIGHT;

// Text box colors
inline FGUI::COLOR COLOR_CTEXTBOX_BG = COLOR2;
inline FGUI::COLOR COLOR_CTEXTBOX_BORDER = COLOR1;
inline FGUI::COLOR COLOR_CTEXTBOX_BORDER_HOVER = COLOR5;
inline FGUI::COLOR COLOR_CTEXTBOX_LABEL = TEXTLIGHT;