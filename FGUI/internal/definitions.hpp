...
namespace FGUI
{
	...
	using KEY_CODES = struct SKeyCodes_t
	{
		...
		const std::string_view m_strVirtualKeyCodes[223] = { "INVALID", "M1", "M2", "", "M3", "M4", "M5", "",
															"BACK", "TAB", "", "", "", "ENTER", "", "", "SHIFT", "CTRL", "ALT",
															"PAUSE", "CAPS", "", "", "", "", "", "", "ESC", "", "", "", "",
															"SPACE", "PGUP", "PGDOWN", "END", "HOME", "LEFT", "UP", "RIGHT",
	...
	using KEY_STRINGS = struct SKeyStrings_t
	{
		...
		// Custom Key Codes
		const std::string_view m_strCustomKeyCodes[256] = { "", "", "", "", "", "", "", "",
															"", "", "", "", "", "", "", "", "", "", "",
															"", "", "", "", "", "", "", "", "", "", "", "", "",
															"", "", "", "", "", "", "", "",
															"", "", "", "", "", "", "", "", "0", "1", "2", "3",
	...
	using WIDGET_BIND_TYPE = enum struct ESWidgetBindType_t {
		NONE = 0,
		INT,
		BOOL,
		FLOAT
